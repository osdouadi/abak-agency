...
const HeroSection = () => {
  return (
    <section className="min-h-screen w-full md:pt-36 relative flex items-center justify-center flex-col overflow-hidden">
      ...
      <p className="text-center text-xl md:text-2xl pb-1 z-10">نلبي أفكارك بأعلى جودة</p>
      <div className="bg-gradient-to-t from-primary to-secondary-foreground text-transparent bg-clip-text relative z-10">
        <h1 className="text-8xl font-bold text-center md:text-[250px] md:pb-10">
          اباك
        </h1>
      </div>
