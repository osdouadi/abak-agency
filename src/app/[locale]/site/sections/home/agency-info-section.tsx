...
const AgencyInfoSection = () => {
  return (
    <section className="min-h-screen w-full flex flex-col gap-5 px-4 md:px-10 md:mt-10 ">
      <div className="flex items-center flex-col md:flex-row gap-5">
        <div className="w-full md:w-[37%] h-[33rem] md:h-[30rem] relative rounded-md overflow-hidden">
