...
const HeroContainer = () => {
  ...
  return (
    <section className="w-full pb-16 md:pt-36 relative flex items-center justify-center flex-col overflow-hidden">
      ...
      <p className="text-center text-xl md:text-3xl pb-1 z-10">
      ...
      <div className="bg-gradient-to-t from-primary to-secondary-foreground text-transparent bg-clip-text relative z-10">
        <h1 className="text-8xl font-bold text-center md:text-[200px] md:pb-10">
